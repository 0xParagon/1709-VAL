...
auto init_wndparams(HWND hWnd) -> HRESULT
{
	...
	const ImColor accentCol = ImColor(38, 44, 54, 255);
	const ImColor bgSecondary = ImColor(38, 44, 54, 255);
	s.Colors[ImGuiCol_WindowBg] = ImColor(38, 44, 54, 255);
	s.Colors[ImGuiCol_ChildBg] = bgSecondary;
	s.Colors[ImGuiCol_FrameBg] = ImColor(73, 146, 255, 255);
	s.Colors[ImGuiCol_FrameBgActive] = ImColor(73, 146, 255, 255);
	s.Colors[ImGuiCol_Border] = ImColor(73, 146, 255, 255);
	s.Colors[ImGuiCol_CheckMark] = ImColor(28, 31, 37, 255);
	s.Colors[ImGuiCol_SliderGrab] = ImColor(28, 31, 37, 255);
	s.Colors[ImGuiCol_SliderGrabActive] = ImColor(28, 31, 37, 255);
	s.Colors[ImGuiCol_ResizeGrip] = ImColor(24, 24, 24, 255);
	s.Colors[ImGuiCol_Header] = ImColor(0, 255, 137, 255);
	s.Colors[ImGuiCol_HeaderHovered] = ImColor(0, 255, 137, 255);
	s.Colors[ImGuiCol_HeaderActive] = ImColor(0, 255, 137, 255);
	s.Colors[ImGuiCol_TitleBg] = ImColor(73, 146, 255, 255);
	s.Colors[ImGuiCol_TitleBgCollapsed] = ImColor(73, 146, 255, 255);
	s.Colors[ImGuiCol_TitleBgActive] = ImColor(73, 146, 255, 255);
	s.Colors[ImGuiCol_FrameBgHovered] = ImColor(73, 146, 255, 255);
	...
	s.Colors[ImGuiCol_Header] = ImColor(73, 146, 255, 255);
	s.Colors[ImGuiCol_HeaderHovered] = ImColor(73, 146, 255, 255);
	s.Colors[ImGuiCol_HeaderActive] = ImColor(73, 146, 255, 255);
	s.Colors[ImGuiCol_PopupBg] = ImColor(15, 15, 15, 255);
	s.Colors[ImGuiCol_Button] = ImColor(147, 112, 219, 255);
	s.Colors[ImGuiCol_ButtonHovered] = ImColor(147, 112, 219, 255);
	s.Colors[ImGuiCol_ButtonActive] = ImColor(147, 112, 219, 255);
	s.Colors[ImGuiCol_Text] = ImColor(255, 255, 255, 255);
	s.Colors[ImGuiCol_TabActive] = ImColor(147, 112, 219, 255);
	s.Colors[ImGuiCol_Tab] = ImColor(147, 112, 219, 255);
	s.Colors[ImGuiCol_TabHovered] = ImColor(147, 112, 219, 255);
